    ...
    <>
      <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-10 left-10 w-4 h-4 bg-white opacity-10 rounded animate-pulse"></div>
          <div className="absolute top-20 right-20 w-6 h-6 bg-white opacity-10 rounded animate-pulse delay-100"></div>
          <div className="absolute bottom-20 left-20 w-3 h-3 bg-white opacity-10 rounded animate-pulse delay-200"></div>
          <div className="absolute bottom-10 right-10 w-5 h-5 bg-white opacity-10 rounded animate-pulse delay-300"></div>
        </div>
