            ...
            >
              <CardContent className="p-0">
                ...
                `}>
                  ...
                  {/* Hover Content */}
                  <div className="absolute inset-0 bg-slate-900/98 rounded-2xl p-8 flex flex-col justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="text-center">
                      <block.icon className="w-16 h-16 mx-auto mb-6 text-emerald-400" />
                      <h2 className="text-2xl font-bold mb-6 text-white">
                        {block.hoverContent.headline}
                      </h2>
                      
                      <div className="grid grid-cols-1 gap-3 mb-6">
                        {block.hoverContent.stats.map((stat, index) => (
                          <div key={index} className="bg-emerald-500/20 rounded-lg px-3 py-2">
                      ...
                      <p className="text-sm text-slate-100 leading-relaxed">
                        {block.hoverContent.description}
                      </p>
                    </div>
                  </div>
                </div>
